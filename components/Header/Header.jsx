...
import logo from './Ilumalogo2.svg'
        ...
        <>
            <header className={`${isFixed ? '' : 'absolute'}`}>
                <Link href='/' className='logo-container'>
                    <Image src={logo} alt='ilumastorelogo' width={100} height={100} />
                    <div className='name'>
                        <span>TereaStore</span>
                    </div>
                </Link>
                <div className='menu'>
                ...
                <div className='cart-menu'>
                    <button className="basket btn-primary position-relative" type="button" data-bs-toggle="offcanvas" data-bs-target="#cart" aria-controls="offcanvasRight">
                        ...
                        {cartItems.length > 0 ? 
                        <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style={{color:'black'}}>
                            {cartItems.length}
                        </span>: ''}
                    </button>
